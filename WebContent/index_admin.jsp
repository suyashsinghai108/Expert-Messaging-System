...
<body>
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-6 col-xs-8">
				<ul class="top-nav nav-right">
					...
					<li><a href="registerexpert.jsp"><i class="fa fa-user-plus" aria-hidden="true"></i>Register Expert</a>
					</li>
					<li class="dropdown"> 
	...
	<!-- =-=-=-=-=-=-= HOME =-=-=-=-=-=-= -->
		...
		<div class="search-area container">
			...
			<p class="search-tag-line">If you want to search any question you can write what you are looking for!</p>
