...
<html>
    ...
    <body>
        ...
        out.println("swal('Server Message', 'You have successfully done registration of expert in ExpertMessaging , and password is sent on expert's email Id. ', 'success');");
        out.println("});");
        out.println("</script>");
        %>
